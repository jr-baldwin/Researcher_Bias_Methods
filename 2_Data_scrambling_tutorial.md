...
For the sake of this tutorialgit config --global user.name "YOUR\_USERNAME", we will first simulate data to be scrambled. If you wish to scramble your own dataset without following the simulation, please skip to [Scramble data](#link2) for the code.
